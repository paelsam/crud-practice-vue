<template>
  <div id="tabla-personas">
    <div v-if="people.length === 0" class="alert alert-info" role="alert">
    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="persona in people" :key="persona.id">
...
<script>
export default {
  // Le damos un nombre al componente
  name: "tabla-personas",
  props: {
    people: Array,
  },
  ...
  methods: {
    editarPersona(persona) {
      // Object.assing copia todas las propiedades de un objeto a otro
